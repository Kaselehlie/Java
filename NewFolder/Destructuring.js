...
console.log(`Key Locations: ${first}, ${second}`); //console printed "Cave of wonders, Lake of Mystery"
...
console.log(`Door Code Sequence: ${upper}, ${middle}, ${lower}`); //console printed 'Door Code Sequence: Alpha, Mount of Ages, Omega'
...
console.log(`Riddle Translation: ${translation}`); //console printed 'Riddle Translation: Sphinx'
...
console.log(`Essential Elements: ${firstElement}, ${secondElement}`); //console printed 'Essential Elements: Fire, Water'
...
console.log(`Extracted Stones: ${firstStone}, ${sixthStone}`); //console printed 'Extracted Stones: 1, 6'
...
console.log(`Visible Shadow: ${visibleShadow}`); //console printed 'Visible Shadow: Darkness'
console.log("Hidden Shadows:", hiddenShadows); //console printed 'Hidden Shadows: [ "Silence", "Whisper", "Echo" ]'
...
revealPath({ direction: "North", distance: "100 meters" }); //console printed 'Direction: North, Distance: 100 meters'
...
mixPotion({ ingredient1: "Peppermint" }); //console printed 'mix: Peppermint and Fireflower'
...
const spellIngredients = ["Moonstone", "Stardust", "Dragon Scale"];
castSpell(spellIngredients); //console printed 'Casting spell with: Moonstone and Stardust'
...
console.log(`Unveiled Secret: ${finalKey}`); //console printed 'Unveiled Secret: The Final Key'
...
console.log(stoneA); //console printed 'Ruby'
console.log(stoneB); //console printed 'Emerald'
