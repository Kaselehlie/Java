...
//Observations:
//TODO: Explain here:----->when I tried to change the value of travelDate, console printed TypeError because constants cannot be reassigned
//----------------------------------------------------------------------------------------------------------------------------------------
...
//Observations:
// TODO: Explain here:----->When I tried to print the variable before declaring it, console printed 'undefined'. After I declared it using "var" and assigned its value, then it worked. Variables declared with 'var' are hoisted to the top of their scope but are not initialized until the declaration is evaluated.
